...
function validarcampos(contenedor, bFilter = false, bRequerido = false) {
              ...
              switch (tipoinput) {
                  case "email":
                      if (!email_filter.test(valor) || valor.match(email_illegalChars)) {
                          ...
                          $(this).parents(".tooltips").find(".spanValidacion").toggleClass("hidden", false).text(mensajeAlerta);
                          $(this).parents(".tooltips").find(".spanValidacion").fadeIn();
                          $("html,body").animate({ scrollTop: $(this).parents(".tooltips").find(".spanValidacion").offset().top - 80 }, 200, "swing", function () {
                              $(this).focus();
                          });
                          return false;
                      } else {
                          banderaRespuesta = validarlenghtcampo(this, valor, mensajeAlerta, minimoCaracteres, maximoCaracteres, " caracteres");
                          if (!banderaRespuesta) {
                              return false;
                          }
                      }
                  ...
                  case "text":
                      if (valor.trim().length == 0) {
                          ...
                          if ($(this).hasClass("decimalHC") || $(this).hasClass("numero") || $(this).hasClass("decimal-one")) {
                              valor = valor.replace(",", ".");
                              if (isNaN(valor)) {
                                  banderaRespuesta = false;
                                  $(this).parents(".tooltips").find(".spanValidacion").toggleClass("hidden", false).text("Este campo es numerico");
                                  $(this).parents(".tooltips").find(".spanValidacion").fadeIn();
                                  $("html,body").animate(
                                      {
                                          scrollTop: $(this).parents(".tooltips").find(".spanValidacion").offset().top - 10,
                                      },
                                      200,
                                      "swing",
                                      function () {
                                  ...
                                  if ("min" in this.dataset === true && "max" in this.dataset === true) {
                                      var min = parseInt(this.dataset.min);
                                      var max = parseInt(this.dataset.max);
                                      if (valor < min || valor > max) {
                                          banderaRespuesta = false;
                                          $(this).parents(".tooltips").find(".spanValidacion").toggleClass("hidden", false).text("El valor esta por fuera de los limites, valor entre " + min + " y " + max);
                                          $(this).parents(".tooltips").find(".spanValidacion").fadeIn();
                                          $("html,body").animate(
                                              {
                                                  scrollTop: $(this).parents(".tooltips").find(".spanValidacion").offset().top - 10,
                  ...
                  case "number":
                      if (typeof pattern !== typeof undefined && pattern !== false && pattern != null) {
                      ...
                      if (!numeric_filter.test(valor)) {
                          ...
                          banderaRespuesta = validarlenghtcampo(this, valor, mensajeAlerta, minimoCaracteres, maximoCaracteres, " dígitos");
                          if (!banderaRespuesta) {
                              return false;
                          }
                      }
...
function validarlenghtcampo(elemento, valor, titulo, minimo, maximo, tipocaracteres) {
  var valor = valor;
  ...
  if (typeof minimoCaracteres !== typeof undefined && minimoCaracteres !== false && typeof maximoCaracteres !== typeof undefined && maximoCaracteres !== false) {
      if (minimoCaracteres == maximoCaracteres && numeroCaracteres != minimoCaracteres) {
          mensajeAlerta += "de " + minimoCaracteres + tipocaracteres;
          $(elemento).addClass("required");
          $(elemento).siblings(".spanValidacion").toggleClass("hidden", false).text(mensajeAlerta);
          $(elemento).siblings(".spanValidacion").fadeIn();
          $("html,body").animate({ scrollTop: $(elemento).siblings(".spanValidacion").offset().top - 80 }, 200, "swing", function () {
              $(elemento).siblings(".spanValidacion").focus();
          });
          bandera = false;
      } else if (numeroCaracteres < minimoCaracteres || numeroCaracteres > maximoCaracteres) {
          mensajeAlerta += "entre " + minimoCaracteres + " y " + maximoCaracteres + tipocaracteres;
          $(elemento).addClass("required");
          $(elemento).siblings(".spanValidacion").toggleClass("hidden", false).text(mensajeAlerta);
          $(elemento).siblings(".spanValidacion").fadeIn();
          $("html,body").animate({ scrollTop: $(elemento).siblings(".spanValidacion").offset().top - 80 }, 200, "swing", function () {
  ...
  } else if (typeof minimoCaracteres !== typeof undefined && minimoCaracteres !== false && numeroCaracteres < minimoCaracteres) {
      ...
      bandera = false;
  } else if (typeof maximoCaracteres !== typeof undefined && maximoCaracteres !== false && numeroCaracteres > maximoCaracteres) {
...
function limite_caracteres_animated(elemento) {
  ...
  switch (tipo) {
      ...
      case "text":
          if (typeof pattern !== typeof undefined && pattern !== false && pattern != null) {
              ...
              patternReplaceREG = new RegExp(patternReplace, "g");
              mensajeInvalido = "Solo se permiten espacios,letras,números y los caracteres '#-";
          }
  ...
  if (campoInvalido) {
      ...
      $(elemento).siblings("p.msj-validacion").html(mensajeInvalido).toggleClass("ocultar", false);
...
function limitecaracteres(elemento) {
  ...
  switch (tipo) {
      ...
      case "text":
          if (typeof pattern !== typeof undefined && pattern !== false && pattern != null) {
              ...
              patternReplace = "[^a-zA-Z0-9áéíóúÁÉÍÓÚüÜñÑ,/.-s]";
              patternReplaceREG = new RegExp(patternReplace, "g");
              mensajeInvalido = "Solo se permiten letras, números, espacios y los símbolos .,-/";
          }
  ...
  if (campoInvalido) {
      ...
      elemento.value = caracteres.substr(0, maximoCaracteres);
      $(elemento).addClass("required");
      $(elemento).siblings(".spanValidacion").toggleClass("hidden", false).text(mensajeInvalido);
      $(elemento).siblings(".spanValidacion").fadeIn();
  } else if (caracteres.length > maximoCaracteres) {
      elemento.value = caracteres.substr(0, maximoCaracteres);
  }
...
function validaremail(elemento) {
  ...
  if (!email_filter.test(valor) || valor.match(email_illegalChars)) {
      $(elemento).val("");
      $(elemento).tooltip("hide").attr("data-original-title", mensajeAlerta).tooltip("fixTitle");
      $(elemento).focus();
      return false;
  } else {
...
function mostrarvalidaciontitle(input) {
  ...
  switch (tipoInput) {
      case "text":
          ...
          $(input).siblings(".spanValidacion").toggleClass("hidden", false).text(mensajeAlerta);
          $(input).parents(".tooltips").find(".spanValidacion").fadeIn();
          $("html,body").animate({ scrollTop: $(input).siblings(".spanValidacion").offset().top - 80 }, 200, "swing", function () {
              $(input).focus();
          });
          break;
      case "email":
...
function validarsummernote(id) {
  ...
  if (code) {
      ...
      $(id).siblings(".spanValidacion").toggleClass("hidden", false).text(mensajeAlerta);
...
function validarcontrasenias(elemento1, elemento2) {
  ...
  if (original === replica) {
      ...
      $(elemento2).parents(".form-group").siblings(".spanValidacion").toggleClass("hidden", false).text(mensajeAlerta);
      $(elemento2).parents(".tooltips").find(".spanValidacion").fadeIn();
      $("html,body").animate({ scrollTop: $(elemento2).parents(".tooltips").find(".spanValidacion").offset().top - 80 }, 200, "swing", function () {
          $(elemento2).focus();
      });
      return false;
  }
...
function validaTipoArchivo(elemento, tipoArchivo) {
  var arrayAdobe = ["application/pdf", "application/postscript", "image/vnd.adobe.photoshop"];

  var arrayBinarios = ["application/octet-stream"];

  var arrayComprension = ["application/x-bzip", "application/x-bzip2", "application/epub+zip"];

  var arrayMicrosoft = ["application/msword", "application/vnd.ms-powerpoint", "application/vnd.ms-excel", "application/rtf", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"];

  var arrayOpenOffice = ["application/vnd.oasis.opendocument.text", "application/vnd.oasis.opendocument.spreadsheet"];
  ...
  var arrayImagenes = ["image/png", "image/jpeg", "image/jpg", "image/gif", "image/bmp", "image/vnd.microsoft.icon", "image/tiff", "image/tiff", "image/svg+xml", "image/x-icon"];
