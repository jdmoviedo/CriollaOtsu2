...
?>
<?= verificar('TypeProduct') ?>
<?= head('Tipo de Productos') ?>
<?= startBody() ?>
<div class="page-header">
    <div class="row align-items-center">
        <div class="col-lg-12">
            <div class="page-header-title">
                <i class="fa-solid fa-basket-shopping bg-blue"></i>
                <div class="d-inline">
                    <h5>Tipo de Productos</h5>
                    <span>Gestión de Tipo de Productos</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-state card-state-success">
            <div class="card-header">
                ...
                <div class="card-header-right crud-card">
                    <ul class="list-unstyled d-flex">
                        <li><i class="ik ik-plus mr-5 cursor-pointer" onclick="showModalRegistro();" data-toggle="tooltip" data-placement="top" title="Crear Tipo de Productos"></i></li>
            ...
            <div class="card-body">
            <table id="dtTypeProduct" class="table ml-0 w-100 table-hover"></table>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmRegistro">
                    <input type="hidden" name="IdTypeProduct" id="IdTypeProduct">
                    <div class="row">
...
<?= endBody(); ?>
<script src="scripts/TypeProduct.js?v=<?php echo (rand()); ?>"></script>