    ...
    <div class="row align-items-center">
        <div class="col-lg-12">
            <div class="page-header-title">
                <i class="fa-solid fa-tags bg-blue"></i>
                <div class="d-inline">
                    <h5>Ingredientes</h5>
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-state card-state-success">
            <div class="card-header">
                ...
                <div class="card-header-right crud-card">
                    <ul class="list-unstyled d-flex">
                        <li><i class="ik ik-plus mr-5 cursor-pointer" onclick="showModalRegistro();" data-toggle="tooltip" data-placement="top" title="Crear Ingredientes"></i></li>
            ...
            <div class="card-body">
            <table id="dtIngredient" class="table ml-0 w-100 table-hover"></table>
...
<?= endBody(); ?>
<script src="scripts/Ingredient.js?v=<?php echo (rand()); ?>"></script>